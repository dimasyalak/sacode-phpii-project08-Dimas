                ...
                <div class="col-6 mx-auto">
                    ...
                    <div class="card shadow bg-dark text-secondary rounded-5">
                        ...
                        <div class="card-header text-center p-5">
                            <h1 class="display-1 fw-bolder text-primary">GAGAL</h1>
                        ...
                        <div class="card-body p-5">
                            ...
                            <?php
                                //menampilkan sesion pesan gagal
                        ...
                        <div class="card-footer text-center py-5">
                            belum punya akun? <a href="login.php" class="fw-bold text-decoration-none">Ulangi Login</a>
                        </div>
                        <!-- .card-footer end -->                        
